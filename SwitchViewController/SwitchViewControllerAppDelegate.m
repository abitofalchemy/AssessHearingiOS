...
//    nav = [[UINavigationController alloc] initWithRootViewController:[[SwitchViewControllerViewController alloc] initWithNibName:@"SwitchViewControllerViewController" bundle:[NSBundle mainBundle ]]];

	nav = [[UINavigationController alloc] initWithRootViewController: 
            [[TTSetupViewController alloc]  initWithDepth:1]];
